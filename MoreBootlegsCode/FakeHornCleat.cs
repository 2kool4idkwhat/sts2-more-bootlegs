...
public class FakeHornCleat : MoreBootlegsRelic
{
    private const string _customIconPath = "res://MoreBootlegs/images/horn-cleat.png";
    ...
    public override async Task AfterBlockCleared(Creature creature)
    {
        ...
        if (creature.CombatState.RoundNumber == 2 && creature == Owner.Creature)
        {
            Flash();
